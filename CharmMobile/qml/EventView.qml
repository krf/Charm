...
Item {
    ...
    signal stateChanged
    signal startTaskRequested(int taskid)

    function goBack() {
        listView.model.rootIndex = listView.model.parentModelIndex()
    }

    function canGoBack() {
        console.log(listView.model.rootIndex != listView.model.parentModelIndex())
        return listView.model.rootIndex != listView.model.parentModelIndex();
    }
    ...
    Component.onCompleted: {
        taskDataModel.rootIndexChanged.connect(stateChanged)
    }
}
